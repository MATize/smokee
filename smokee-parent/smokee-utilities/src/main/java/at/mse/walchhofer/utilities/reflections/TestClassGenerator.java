...
public class TestClassGenerator {
	...
	public static void generate(String className, int methodCnt, int annotationCnt, String annotationFQN) throws CannotCompileException, IOException, ClassNotFoundException, NotFoundException  {

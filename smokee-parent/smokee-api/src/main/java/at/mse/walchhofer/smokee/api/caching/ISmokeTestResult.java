...
public interface ISmokeTestResult extends Serializable {
     ...
     *         {@code TRUE}: wenn Testergebnis dem erwarteten Testresultat
     *         entspricht<br />
    ...
    /**
     * Der Testcontext<br />
     * Dieser Wert wird ueber Eigenschaft {@code project.jndi.prefix} die in der
     * die Datei {@code META-INF/smoker.properties} definiert wird, festgelegt.
     * 
    ...
    /**
     * Der Testcontext<br />
     * Dieser Wert wird Standardmaeszig ueber die Eigenschaft
     * {@code project.jndi.prefix} die in der die Datei
     * {@code META-INF/smoker.properties} definiert wird, festgelegt.
     * 
     */
     ...
     * 
     * @param lastRun
     *            Zeitpuntk der letzten Testausfuehrung
     */
     ...
     * 
     * @param elapsedTime
     *            die benoetigte Zeit der Testausfuehrung
     */
     ...
     * 
     * @param passed
     *            Information ob der Test das definierte erwartete Ergebnis
     *            retourniert hat
     */

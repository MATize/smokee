 ...
 * Daher wird <a href="http://tools.ietf.org/html/rfc6648">http://tools.ietf.org/html/rfc6648</a> ignoriert. 
 * 
...
public class Constants {
	 ...
	 * Jeder Aufrufer erhaelt einen eigenen API_KEY, ohne dem der Zugriff auf SmokEE unterbinden wird. 
	 */
	public static final String HTTP_HEADER_API_KEY = "X-SMOKER-API-KEY";
	
	/**
	 * HTTP-HEADER fuer den AUTH-Schluessel.<br/>
	 * Dieser Schluessel wird automatisch erzeugt, wenn das Sicherheitssystem mit einem korrekten API_KEY, Benuztername und Passwort aufgerufen wurde.<br />
	 * Der AUTH_TOKEN ermoeglicht den Zugriff auf SmokEE zusammen mit API_KEY ohne eine erneute Authentifzierung mit Benutzernamen und Passwort durchfuehren zu muessen  
	 */
